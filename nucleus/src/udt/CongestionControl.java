...
public interface CongestionControl {
	...
	/**
	 * update packet arrival rate and link capacity with the values received in
	 * an ACK packet
	 * 
	 ...
	 * 
	 * @param ackSeqno - the data sequence number acknowledged by this ACK. see spec. page(16-17)
	 */
